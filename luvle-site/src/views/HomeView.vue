...
<i18n lang="json">
{
  ...
  "es": {
    ...
    "_emphasis": "",
    "about": "Soy Ingeniero de Software (Senior) en {current_job}. {break} Tambien soy {patentHolder}, {familyMan}, y {reader}.",
  ...
  "ca": {
    ...
    "about": "Sóc Enginyer de Software (Sènior) a {current_job}. {break} També sóc {patentHolder}, {familyMan}, i {reader}. {emphasis}",
